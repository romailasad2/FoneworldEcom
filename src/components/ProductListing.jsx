...
const ProductListing = () => {
  ...
  const loadData = async () => {
    try {
      ...
      // Set max price from products (only once on initial load to prevent flickering)
  ...
  return (
    <div className="product-listing">
      <div className="listing-header">
        <h2 className="page-title">Mobile Phones</h2>
        <p className="page-subtitle">Browse our inventory across 16 branches</p>
      </div>
          ...
          {filteredProducts.length > 0 ? (
            <div className="products-grid">
              {filteredProducts.map(product => (
                <ProductCard key={product.id} product={product} branches={branches} />
              ))}
            </div>
          ) : (
